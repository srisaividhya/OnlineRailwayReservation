...
export class TrainDetailsService {
  ...
  constructor(private http: HttpClient) { 
    ...
    this.addTrainDetailsURL = 'http://localhost:8081/trains/addTrain';
    this.getTrainDetailsURL = 'http://localhost:8084/search/findAllTrains';
    this.updateTrainDetailsUrl = 'http://localhost:8081/trains/update';
    this.deleteTrainDetailsUrl ='http://localhost:8081/trains/delete/';
